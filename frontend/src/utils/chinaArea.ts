...
export const chinaAreaOptions: ChinaAreaOption[] = [
  { name: "北京市", cities: ["北京市"] },
  { name: "天津市", cities: ["天津市"] },
...
export const chinaCascaderOptions = chinaAreaOptions.map((area) => ({
  value: area.name,
  label: area.name,
  children: area.cities.map((city) => ({ value: city, label: city })),
}));
